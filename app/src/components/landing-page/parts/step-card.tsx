...
export const StepCard = ({ idx, text, title }: Props) => {
  ...
  const line =
    idx === 1
      ? "bg-primary_to absolute lg:h-[6px] -z-[1] h-[80%] sm:h-[80%] w-[6px] lg:w-[50%] bottom-0 left-0 lg:top-1/2 lg:transform lg:-translate-y-1/2"
      : idx === 2
      ? "lg:bg-gradient-to-l bg-gradient-to-b via-primary_to from-primary_to sm:h-[80%] to-primary sm:bottom-0 absolute h-[100%] w-[6px]  lg:h-[6px] -z-[1] lg:w-[100%] left-0 lg:top-1/2 lg:transform lg:-translate-y-1/2"
      : idx === 3
  ...
  return (
    <div className="z-[2] flex flex-1 rounded-[40px] bg-white pr-4 shadow-main lg:mt-4 lg:flex-col lg:py-10 lg:pr-0">
