...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn(
      "border-b border-b-slate-200 mb-6 z-20 shadow-main rounded-md bg-gradient-to-r border border-[#E8A5AD] from-faq_from to-faq_to cursor-pointer dark:border-b-slate-700",
      className
    )}
    {...props}
  />
